...
public class CommandBuilder {
    ...
    public static BaseCommand parseInteractiveCommand(String line, MicroShell microShell) throws EOFException {
    ...
    public static ArrayList<BaseCommand> parseScriptCommands(MicroShell microShell, ArrayList<String> lines) {
